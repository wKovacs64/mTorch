 ...
 */
@TargetApi(Build.VERSION_CODES.M) public final class PermissionUtils {
  ...
  public static void requestCameraPermissions(@NonNull final Activity activity,
    ...
    if (activity.shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
      Snackbar.make(rootView, R.string.permission_rationale_camera, Snackbar.LENGTH_INDEFINITE)
  ...
  public static void requestCameraPermissions(@NonNull final Activity activity) {
    if (activity.shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
      Toast.makeText(activity, R.string.permission_rationale_camera, Toast.LENGTH_LONG).show();
    } else {
      activity.requestPermissions(PERMISSION_CAMERA, Constants.RESULT_PERMISSION_CAMERA);
    }
  }
