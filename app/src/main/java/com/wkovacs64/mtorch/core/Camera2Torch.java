 ...
 */
@TargetApi(Build.VERSION_CODES.M) public final class Camera2Torch
    extends CameraManager.TorchCallback implements Torch {
  ...
  @Override public void toggle(boolean enabled) {
    try {
