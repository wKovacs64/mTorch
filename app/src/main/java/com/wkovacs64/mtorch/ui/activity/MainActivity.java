...
public final class MainActivity extends AppCompatActivity
  ...
  @BindView(R.id.container) LinearLayout rootView;
  @BindView(R.id.app_bar) Toolbar appBar;
  @BindView(R.id.torch_image_button) ImageButton imageButton;
  ...
  private void processPermissionResults() {
    if (cameraPermissionDenied && !ActivityCompat.shouldShowRequestPermissionRationale(this,
        Manifest.permission.CAMERA)) {
      Timber.d("Instructing user to grant permissions manually.");
      Snackbar.make(rootView, R.string.content_camera_permission_denied, Snackbar.LENGTH_INDEFINITE)
   ...
   */
  @Subscribe public void onTorchStateEvent(TorchStateEvent event) {
   ...
   */
  @Produce public ToggleRequestEvent produceToggleRequestEvent() {
